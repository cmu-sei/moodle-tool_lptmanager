...
$string['sync'] = 'Create';
$string['syncall'] = 'Create All Learning Plan Templates';
$string['syncall_help'] = 'Create All Learning Plan Templates instead of just one';
$string['syncnavlink'] = 'Create learning plan templates';
...
$string['syncnavlink'] = 'Create learning plan templates from competency framework';
$string['id'] = 'ID';
...
$string['confirm_sync'] = 'Please confirm the creation of the following competencies:';
$string['confirm_sync_heading'] = 'Learning Plan Templates to be Created';
...
$string['syncnote'] = '<strong>Instructions:</strong> Enter an expression to match competency ID numbers. For each matching competency, the tool will generate a learning plan template and it will add the cross-referenced competencies to the learning plan template.';
