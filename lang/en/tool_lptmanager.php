...
$string['importnote'] = '<strong>Note:</strong> Before importing learning plan templates into Moodle, ensure that any associated competency frameworks have already been imported.';
$string['exportnote'] = '<strong>Note:</strong> After exporting the learning plan templates, you may also wish to export any competency frameworks used by these learning plan templates';
$string['confirm_sync'] = 'Please confirm synchronization of the following competencies:';
$string['confirm_sync_heading'] = 'Learning Plan Templates to be Synced';
...
$string['syncnote'] = '<strong>Note:</strong> Enter an expression to match competency ID numbers. For each matching competency, the tool will generate a learning plan template and it will add the cross-referenced competencies to the learning plan template.';
